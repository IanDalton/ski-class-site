          ...
          <div className="flex items-center gap-8">
            <ul className="flex space-x-8">
              <li>
                <a 
                  href="#home" 
                  className="text-gray-700 font-medium text-gray-700 relative transition-colors duration-150 hover:text-blue-600 after:content-[''] after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-0.5 after:bg-blue-600 after:transition-all after:duration-250 hover:after:w-full"
                >
                  {t('nav.home')}
                </a>
              </li>
